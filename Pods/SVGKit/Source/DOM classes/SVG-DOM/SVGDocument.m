 ...
 */
+(void) accumulateNamespacesForNode:(SVGKNode*) node intoDictionary:(NSMutableDictionary*) output
{
	/**
	...
	{
	SVGKNode * namespaceDeclaration = [xmlnsNodemap objectForKey:xmlnsNodeName];
	...
	for(SVGKNode * childNode in node.childNodes )
	{
