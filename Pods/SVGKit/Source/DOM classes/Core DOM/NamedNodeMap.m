...
{
SVGKNode * simpleResult = [self.internalDictionary objectForKey:name];
...
SVGKNode * oldNode = [self.internalDictionary objectForKey:arg.localName];
...
SVGKNode * oldNode = [self.internalDictionary objectForKey:name];
...
{
	NSMutableDictionary* namespaceDict = [self.internalDictionaryOfNamespaces objectForKey:namespaceURI];
SVGKNode * oldNode = [namespaceDict objectForKey:localName];
...
SVGKNode * oldNode = [namespaceDict objectForKey:arg.localName];
